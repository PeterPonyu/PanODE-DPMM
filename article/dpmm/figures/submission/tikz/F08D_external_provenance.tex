% Created by tikzDevice version 0.12.6 on 2026-08-03 04:29:01
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74,113.88) {Primary per-variant Wilcoxon in-repo};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74, 90.94) {DPMM-Base: 407 tests; 176 sig wins};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74, 68.01) {Core: 31/44 (NMI9 ARI9 ASW7 DAV6)};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74, 45.08) {Residual: raw score dumps not imported};
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.90] at ( 38.15,152.18) {Provenance closed};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (210.78,171.36);
\definecolor{drawColor}{RGB}{0,0,0}
