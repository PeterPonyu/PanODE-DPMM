% Created by tikzDevice version 0.12.6 on 2026-08-03 04:28:51
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74,113.88) {Statistics: 56 datasets x 18 baselines};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74, 90.94) {Display: 12 complete core datasets};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74, 68.01) {11 representative baseline methods};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at ( 51.74, 45.08) {pairwise upstream exports: PENDING};
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.90] at ( 38.15,152.18) {Selection and provenance};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (210.78,171.36);
\definecolor{drawColor}{RGB}{0,0,0}
