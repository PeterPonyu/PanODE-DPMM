% Created by tikzDevice version 0.12.6 on 2026-08-10 06:16:03
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at (285.72,112.20) {Primary per-variant Wilcoxon in-repo};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at (285.72, 89.27) {DPMM-Base: 407 tests; 176 sig wins};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at (285.72, 66.34) {Core: 31/44 (NMI9 ARI9 ASW7 DAV6)};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.77] at (285.72, 43.40) {Residual: raw score dumps not imported};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (473.86,364.00);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.90] at (272.14,146.51) {\bfseries Provenance closed};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (473.86,364.00);
\definecolor{drawColor}{RGB}{0,0,0}
