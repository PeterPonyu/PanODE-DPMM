...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F01_architecture}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F02_tradeoff}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F03_statistics}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F04_sensitivity}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F05_training}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F06_biological}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F07_external_selection}
\caption{\textbf{External benchmark scope and selection.} Panels~(a)--(c) report full-screen significant wins, core significant wins, and core win rates from the in-repository canonical summary. Panel~(d) distinguishes the 56-dataset, 18-baseline statistical screen from the 12-dataset, 11-baseline selected visualization and marks the missing pairwise upstream provenance.}
\label{fig:external}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F08_external_provenance}
\caption{\textbf{External evidence decomposition and provenance boundary.} Panels~(a)--(c) summarize the in-repository win-rate export and test coverage. Panel~(d) explicitly marks metric-family decomposition as PENDING-PROVENANCE because the authoritative upstream pairwise external exports are absent; no ASW/DAV-specific external counts are reconstructed.}
...
DPMM-Base achieves a core win rate of 70.5\%, winning 31 of 44 core-metric comparisons against external baselines, with 176 total significant wins across all metrics in the full 56-dataset, 18-baseline screen. This advantage is concentrated on ASW and DAV; on NMI alone, several external baselines---notably scVI~\cite{lopez2018deep} and CLEAR---match or exceed DPMM-Base on individual datasets, consistent with the geometry--concordance trade-off observed internally. The canonical summary is archived with the manuscript; the remaining upstream pairwise-export boundary is documented in \texttt{PROVENANCE-GAP.md}.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F09_utility_cost}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F10_decision_map}
